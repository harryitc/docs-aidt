---
title: Liên hệ
description: Thông tin liên hệ và hỗ trợ kỹ thuật của Viện Trí tuệ Nhân tạo và Chuyển đổi số (AIDT) – HUTECH.
---

# Liên hệ

Cần hỗ trợ về **Canvas LMS** hoặc các hệ thống của **AIDT**? Vui lòng liên hệ:
...
- Họ tên và **mã số** (sinh viên/giảng viên).
