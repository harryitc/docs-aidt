...
::: tip Bắt đầu từ đâu?
- <Icon name="life-buoy" /> Cần **hướng dẫn sử dụng** một hệ thống? → Vào mục [Hỗ trợ](/lms/).
- <Icon name="monitor" /> Muốn biết AIDT có những **hệ thống** nào? → Xem [Hệ thống AIDT](/he-thong-aidt/).
- <Icon name="phone" /> Cần **trợ giúp trực tiếp**? → [Liên hệ](/lien-he/).
:::
...
| --- | --- | --- |
| <Icon name="life-buoy" /> **Hỗ trợ** | Hướng dẫn & xử lý sự cố các hệ thống | [Xem](/lms/) |
| <Icon name="monitor" /> **Hệ thống AIDT** | Danh mục nền tảng số đang vận hành | [Xem](/he-thong-aidt/) |
| <Icon name="bot" /> **AI & Chuyển đổi số** | Giải pháp AI và chuyển đổi số | [Xem](/he-thong-aidt/) |
| <Icon name="phone" /> **Liên hệ** | Kênh hỗ trợ trực tiếp | [Xem](/lien-he/) |

> <Icon name="lightbulb" /> Hệ thống đang được hỗ trợ hiện tại: **Canvas LMS**. Các hệ thống và tài liệu khác sẽ được bổ sung tại đây.
