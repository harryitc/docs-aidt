/* Nội dung (path) của các icon — dùng chung cho component <Icon> và frontmatter trang chủ.
   Tất cả vẽ trên viewBox 0 0 24 24, nét currentColor, stroke-width 2. */
export const ICONS: Record<string, string> = {
  // Hỗ trợ / phao cứu sinh
  'life-buoy':
  ...
  // Chuyển đổi số / làm mới
  'refresh-cw':
    '<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/>',
  // Xây dựng / tạo khoá học
  hammer:
...
export function svgIcon(name: string, size: number | string = '1.1em'): string {
